...
@Autonomous(name ="Red_Backdrop_Park", group = "RED")
public class Red_Backdrop_Park extends LinearOpMode {
    ...
    void generatePaths(SampleMecanumDrive drive)
    {
        goToParkLeft =  drive.trajectorySequenceBuilder(new Pose2d(startX, startY, startHeading))
                ...
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(120, -150, Math.toRadians(0)), Math.toRadians(90))
                .setReversed(false)
                .splineToConstantHeading(new Vector2d(153, -153), Math.toRadians(90))
                .build();
        ...
        goToParkMiddle = drive.trajectorySequenceBuilder(new Pose2d(startX, startY, startHeading))
                ...
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(120, -150, Math.toRadians(90)), Math.toRadians(90))
                .setReversed(false)
                .splineToConstantHeading(new Vector2d(153, -153), Math.toRadians(90))
                .build();
        ...
        goToParkRight = drive.trajectorySequenceBuilder(new Pose2d(startX, startY, startHeading))
                ...
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(30, -140, Math.toRadians(90)), Math.toRadians(90))
                .setReversed(false)
                .splineToLinearHeading(new Pose2d(120, -150, Math.toRadians(90)), Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(153, -153), Math.toRadians(90))
                .build();

...
@Autonomous(name ="Blue_Audience_Park", group = "BLUE")
public class Blue_Audience_Park extends LinearOpMode {
    ...
    void generatePaths(SampleMecanumDrive drive)
    {
        goToParkLeft =  drive.trajectorySequenceBuilder(new Pose2d(startX, startY, startHeading))
                .splineTo(new Vector2d(-73, 107), Math.toRadians(315))
                .setReversed(true)
                .lineToLinearHeading(new Pose2d(-100, 140, Math.toRadians(270)))
                .setReversed(false)
                .splineToConstantHeading(new Vector2d(-150, 90), Math.toRadians(270))
                .splineToConstantHeading(new Vector2d(-150, 30), Math.toRadians(270))
                .splineToConstantHeading(new Vector2d(-120, 35), Math.toRadians(270))
        ...
        goToParkMiddle = drive.trajectorySequenceBuilder(new Pose2d(startX, startY, startHeading))
                .splineTo(new Vector2d(-85, 80), Math.toRadians(270))
                .setReversed(true)
                .lineToLinearHeading(new Pose2d(-100, 140, Math.toRadians(270)))
                .setReversed(false)
                .splineToConstantHeading(new Vector2d(-150, 90), Math.toRadians(270))
        ...
        goToParkRight = drive.trajectorySequenceBuilder(new Pose2d(startX, startY, startHeading))
                .splineTo(new Vector2d(-113, 100), Math.toRadians(225))
                .setReversed(true)
                .lineToLinearHeading(new Pose2d(-100, 140, Math.toRadians(270)))
                .setReversed(false)
                .splineToConstantHeading(new Vector2d(-150, 90), Math.toRadians(270))
